    ...
    <div className="min-h-screen bg-zinc-950 text-white p-6 md:p-10 space-y-10">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-xl text-zinc-400 mt-2">Thinking Portfolio Co-Pilot • Built for Gauteng & ZAR Volatility</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { title: "Total Value", value: `R ${performance.totalValue.toLocaleString()}`, color: "text-white" },
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        ...
        <CardContent className="h-80 flex items-center justify-center bg-zinc-950 rounded-xl border border-dashed border-zinc-700">
          <p className="text-zinc-500 text-center">📈 Recharts Line Chart Ready — Reply "add chart" for full implementation</p>
        </CardContent>
      </Card>
    </div>
  );
